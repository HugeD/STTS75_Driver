...
*/
#define STTS75_ACC_I2C_ADDRESS_READ     ((0x48<<1) | 0x01)	
#define STTS75_ACC_I2C_ADDRESS_WRITE    (0x48<<1)

/************** STTS75 寄存器地址 *****************/
#define STTS75_ACC_I2C_TEMP		0x00
#define STTS75_ACC_I2C_CONF		0x01
#define STTS75_ACC_I2C_THYS		0x02
#define STTS75_ACC_I2C_TOS		0x03
...
*******************************************************************************/
#define  	STTS75_ACC_I2C_TEMP_BIT_SB  		0x8000
#define  	STTS75_ACC_I2C_TEMP_BIT_POSITION  	15
...
*******************************************************************************/
typedef enum {
	STTS75_ACC_CONF_RC_1			= 0x00,	// 0.5 °C
	STTS75_ACC_CONF_RC_2			= (0x01<<5),	// 0.25 °C
	STTS75_ACC_CONF_RC_3			= (0x02<<5),	// 0.125 °C
	STTS75_ACC_CONF_RC_4			= (0x03<<5)	// 0.0625 °C
} STTS75_ACC_CONF_RC_t;

#define  	STTS75_ACC_CONF_RC_MASK  	(0x03<<5)
...
*******************************************************************************/
#define  	STTS75_ACC_THYS_DEF  		0x4B00
...
*******************************************************************************/
#define  	STTS75_ACC_TOS_DEF  		0x5000
